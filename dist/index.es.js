...
const gdscriptHighlighting = styleTags({
  "for while if elif else return break continue pass assert await match case":
    tags.controlKeyword,
  "in not and or is del": tags.operatorKeyword,
  "func class class_name extends const var": tags.definitionKeyword,
  "preload load": tags.moduleKeyword,
  "as PI TAU INF NaN": tags.keyword,
  True: tags.bool,
  False: tags.bool,
  Null: tags.bool,
